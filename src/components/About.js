...
export const About = () => {
    ...
    return (
        <>
            ...
            <p>To use <span id="title">{UIText.appTitle}</span>, you will need a <a href="https://www.flickr.com/services/api/misc.api_keys.html" target="_blank" rel="noreferrer">Flickr API Key</a>, which you'll use to get images to classify. You will also need an <a href="https://beta.openai.com/signup" target="_blank" rel="noreferrer">Open AI Key</a> - <a href="https://openai.com/" target="_blank" rel="noreferrer" >Open AI</a> does the text generation.</p>
